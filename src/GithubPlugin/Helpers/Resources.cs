...
public static class Resources
{
    ...
    public static string[] GetWidgetResourceIdentifiers()
    {
        return new string[]
        {
            ...
            "Widget_Template/PrReviewRequested",
            "Widget_Template/ReviewRequested",
            ...
            "Widget_Template/By",
            "Widget_Template/Ssh_wallet",
            "Widget_Template_Label/Config_file_path",
            "Widget_Template_Label/SystemMemory",
            "Widget_Template_Label/MemoryUsage",
            "Widget_Template_Label/AllMemory",
            "Widget_Template_Label/UsedMemory",
            "Widget_Template_Label/Commited",
            "Widget_Template_Label/Cached",
            "Widget_Template_Label/PagedPool",
            "Widget_Template_Label/NonPagedPool",
